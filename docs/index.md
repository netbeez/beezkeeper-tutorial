...
5. [Anomaly Detection](anomaly-detection.md)
	1. [Alert profiles](anomaly-detection.md#alert-profiles)
	2. [Device alerts](anomaly-detection.md#device-alerts)
	3. [Incidents](anomaly-detection.md#incidents)
	4. [Notifications](anomaly-detection.md#notifications)
6. [Reports and API](reports-and-api.md)
	1. [Legacy Reports](#legacy-reports)
	2. [Reports Beta](#reports-beta)
